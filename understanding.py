...
class Understanding:
    ...
    def __init__(self):
        ...
        self.messages = [{"role": "system", "content": Understanding.PROMPT}]
        for sample in Understanding.SAMPLES:
...
for input in [
    ...
    keypoints = understanding.estimate(input)
    print(input)
    print("========== PODSUMOWANIE ==========")
